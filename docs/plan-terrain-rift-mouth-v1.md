# Bong · plan-terrain-rift-mouth-v1 · Active

> **状态**：⏳ active（2026-05-04 升级，user 拍板覆盖 2026-04-29 倒挂 block）。原"先做 P0 代码再升 active"是倒挂条件——升 active 就是为了开始 P0；前置 plan-tsy-dimension-v1 / plan-tsy-extract-v1 / plan-tsy-hostile-v1 全 ✅ finished，无依赖阻塞。
