...
- ⏳ **P6+ 全未动**：herbalism XP（接 plan-skill-v1）· 偷菜偷灵 · 客户端 UI · 道伥 spawn（npc 系统消费 ZonePressureCrossed）

测试：618/618 全过（botany + lingtian 共 87 单测，含 40 个 ECS / e2e）；我的文件 clippy 0 警告；全套 2.37s。
