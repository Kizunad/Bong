...
- **6.11 A-CS production registration**：`docs/plans-skeleton/plan-agent-craft-schema-v1.md` 在 Wave 0 唯一生产四个 craft TypeBox/generated/dist artifacts，记录 SHA/count 供 R6；未归档时 R6/R4/R7/R1 craft gate 阻塞。
