...
4. TsyPresence 三者 coupled snapshot 的 routine autosave/disconnect crash-injection 细节已由 P1 声明 atomic boundary，但具体 fault-injection harness 与跨连接时序留待 R3 P3 收口；不得因此退回独立 Slice 写入。
