...
|------|------|--------|-----------|-----------|
| `rift_portal` | 两侧 | `spawn_rift_portals` | `direction:entry\|exit`, `kind:main\|deep\|tear`, `family_id:X` | `trigger_radius:N`, `target_family_pos_xyz:[x,y,z]`（entry 必填，指向 TSY dim `_shallow` 中心；exit 由 TsyPresence.return_to 运行时填） |
...
// TSY dim blueprint （zones.tsy.json）
{
  ...
  "pois": [
    { "kind": "rift_portal",    "pos_xyz": [ 50, 100,  50], "tags": ["direction:exit", "kind:main", "family_id:zongmen_01"] },
