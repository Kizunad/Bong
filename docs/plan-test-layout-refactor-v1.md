...
- **提交与主线证据**：代码/Cargo/测试落点收口提交为 `758a10cf7`（2026-09-07，含 `Model: gpt-5.6-luna`）；validator 证据已完成，TSV 已同步；fetch/merge、完整门禁和 PR 结论将在本 PR 的后续证据提交中补录，并保留所有既有 P2/P3/P4 条目。
