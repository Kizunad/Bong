...
- **验证与门禁**：迁移代码 HEAD `ca72b8b6b1f8bbf378e5170f403785e0c846338c` 上，`npc_spawn_unit` 定向为 `8 passed / 0 failed / 0 ignored`，同 crate `npc::spawn::tests` 定向为 `41 passed / 0 failed / 0 ignored`；静态全集为 `49`。无上下文只读 validator、三条 server gate、主线合并复验结果将在本轮收口后补入本 evidence。
- **提交与状态**：代码/测试/Cargo target 提交为 `ca72b8b6b1f8bbf378e5170f403785e0c846338c`（2026-09-14，带 `Model: gpt-5.6-luna`）；本 evidence 追加后独立提交。P2 总体、P3、P4 仍未完成，plan 保持 active、不归档。
