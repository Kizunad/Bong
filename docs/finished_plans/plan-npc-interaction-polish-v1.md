...
- **关键 commit**
  - `d8a5bde72`（2026-05-11）`plan-npc-interaction-polish-v1: 接入 NPC 交互事件协议`
  - `753c82eb9`（2026-05-11）`plan-npc-interaction-polish-v1: 客户端渲染 NPC 交互 HUD`
  - `69a9d55ce`（2026-05-11）`plan-npc-interaction-polish-v1: 补 NPC 交互压测脚本`

- **测试结果**
  - `cargo fmt --check` ✅
  - `CARGO_PROFILE_TEST_DEBUG=0 cargo test -j1 -- --test-threads=1` ✅ `4298 passed; 0 failed`
