...
- `6262c26f` · 2026-05-04 · `feat(tuike): 接入伪皮战斗与制作闭环`
- `248b4632` · 2026-05-04 · `feat(tuike): 对齐 schema 与天道蜕壳叙事`
- `db7890d9` · 2026-05-04 · `feat(tuike): 接入客户端伪皮装备与 HUD`
- `678ca1c3` · 2026-05-04 · `feat(tuike): 记录蜕壳生平战绩`
- `03c69ad9` · 2026-05-04 · `fix(tuike): 收敛防御查询类型`

### 测试结果

- `cd server && cargo test tuike -- --nocapture`：通过；13 tests passed。
- `cd server && cargo fmt --check && cargo clippy --all-targets -- -D warnings && cargo test`：通过；2228 Rust tests passed。
- `cd agent && npm run build && (cd "packages/tiandao" && npm test) && (cd "packages/schema" && npm test)`：通过；tiandao 32 files / 225 tests，schema 9 files / 267 tests。
