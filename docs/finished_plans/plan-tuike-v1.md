...
- `604a99f6` · 2026-05-04 · `feat(tuike): 接入伪皮战斗与制作闭环`
- `50d1a480` · 2026-05-04 · `feat(tuike): 对齐 schema 与天道蜕壳叙事`
- `7c4cb527` · 2026-05-04 · `feat(tuike): 接入客户端伪皮装备与 HUD`
- `757479ff` · 2026-05-04 · `feat(tuike): 记录蜕壳生平战绩`
- `d9cf9f75` · 2026-05-04 · `fix(tuike): 收敛防御查询类型`
- `f9ea4d77` · 2026-05-04 · `fix(tuike): 对齐生平记录格式化`

### 测试结果

- `cd server && cargo test tuike -- --nocapture`：通过；13 tests passed。
- `cd server && cargo fmt --check && cargo clippy --all-targets -- -D warnings && cargo test`：通过；2268 Rust tests passed。
- `cd agent && npm run build && (cd "packages/tiandao" && npm test) && (cd "packages/schema" && npm test)`：通过；tiandao 34 files / 233 tests，schema 9 files / 268 tests。
