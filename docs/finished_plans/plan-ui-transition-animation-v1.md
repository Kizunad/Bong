...
- **关键 commit**：
  - `c45289fd3`（2026-05-10）`feat(client): 增加 UI 过渡动画引擎`
  - `acddc1a94`（2026-05-10）`feat(client): 增加 UI loading 过渡层`
  - `e22ec35e4`（2026-05-10）`feat(client): 接入天道连接状态指示`
  - `886519279`（2026-05-10）`fix(client): 收紧 UI 过渡 review 阻塞项`
- **测试结果**：
