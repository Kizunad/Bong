...
- 最终主线同步：`aec09c58` 普通合入 `origin/main@3123e60f`；主线新增工作台/容器交互与 forge 修复，未触及本 PR 的 `client/social` 文件。合并后 Temurin JDK 17.0.19 完整强制重跑为 451 suites / 3880 tests，0 skipped / failures / errors，并成功产出客户端 jar。
