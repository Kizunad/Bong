...
- **测试结果**：
  ...
  - `JAVA_HOME=$HOME/.sdkman/candidates/java/17.0.18-amzn ./gradlew --no-daemon test build`：通过，`client/build/test-results/test` 汇总 1154 tests / 0 failure / 0 error / 0 skipped。
