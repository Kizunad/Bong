...
| 阶段 | 内容 | 状态 |
|------|------|------|
| P0 | 砍快捷使用 tab + 清理冗余快捷键（I/K/J） | ✅ 2026-05-13 |
| P1 | 手搓 tab → 独立 CraftScreen（对齐 mockup 三栏布局） | ✅ 2026-05-13 |
| P2 | 饱和测试 | ✅ 2026-05-13 |
...
- `e050342f9` · 2026-05-13 · `test(client): 补检视手搓入口 review 覆盖`
...
- `JAVA_HOME="$HOME/.sdkman/candidates/java/17.0.18-amzn" ./gradlew test --tests "com.bong.client.inventory.InspectScreenQuickUseTabTest" --tests "com.bong.client.craft.CraftUxViewModelTest" --tests "com.bong.client.insight.*"` — review 修复后 BUILD SUCCESSFUL。
