...
RIFT_MOUTH_DECORATIONS = (
    ...
    DecorationSpec(
        name="endstone_scar_shard",
        kind="crystal",
        blocks=("end_stone", "purpur_block", "amethyst_cluster"),
        size_range=(2, 3),
        rarity=0.05,
        notes="末石疤痕碎片：portal 入口/容器语义不走 density flora，只放晶体碎片。",
    ),
    DecorationSpec(
        name="bone_root_snarl",
        kind="boulder",
        blocks=("bone_block", "stripped_oak_log", "soul_soil"),
        size_range=(1, 2),
        rarity=0.08,
        notes="骨根缠结：姿态尸体不走 density flora，只保留骨块和枯根。",
    ),
    DecorationSpec(
