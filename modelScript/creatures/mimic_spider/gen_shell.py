...
用法:
  python3 modelScript/creatures/mimic_spider/gen_shell.py            # 框架+甲壳
  python3 modelScript/creatures/mimic_spider/gen_shell.py --only-shell
  python3 modelScript/creatures/mimic_spider/gen_shell.py --group legs
  python3 modelScript/creatures/mimic_spider/gen_shell.py --list
"""
