...
用法:
  python3 modelScript/creatures/horse/gen_pelt.py                       # 9 份全出
  python3 modelScript/creatures/horse/gen_pelt.py --coat dun --profile medium
  python3 modelScript/creatures/horse/gen_pelt.py --with-anatomy        # 叠在骨+肌上看包裹关系
  python3 modelScript/creatures/horse/gen_pelt.py --list
"""
...
def part_legs(p: Pelt, env: Envelope, P) -> None:
    ...
    for sx, side in ((-1, "l"), (1, "r")):
        ...
        # 的那一侧**。剩下的清单跑 `python3 modelScript/creatures/horse/shell_check.py --rom`。
