...
用法:
  python3 modelScript/creatures/horse/gen_tack.py                      # 全部马具 × 三档
  python3 modelScript/creatures/horse/gen_tack.py --kind shoe --tier lingtie --profile large
  python3 modelScript/creatures/horse/gen_tack.py --with-horse         # 叠在皮层上看贴合
  python3 modelScript/creatures/horse/gen_tack.py --suit               # 四种一起穿，看整套
  python3 modelScript/creatures/horse/gen_tack.py --list
"""
