...
用法:
  python3 modelScript/creatures/horse/gen_muscle.py                      # 三档，骨+肌
  python3 modelScript/creatures/horse/gen_muscle.py --profile medium
  python3 modelScript/creatures/horse/gen_muscle.py --only-muscle        # 只看肌肉
  python3 modelScript/creatures/horse/gen_muscle.py --group hindleg
  python3 modelScript/creatures/horse/gen_muscle.py --diagnose           # 裸骨诊断（体素栅格）
"""
...
MODELS = Path(__file__).resolve().parents[2] / "models" / "horse" / "stages"  # 中间产物（骨架 / 肌肉）
