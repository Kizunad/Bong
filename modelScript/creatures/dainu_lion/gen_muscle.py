...
用法:
  python3 modelScript/creatures/dainu_lion/gen_muscle.py                # 骨+肌
  python3 modelScript/creatures/dainu_lion/gen_muscle.py --only-muscle  # 只看肌肉
  python3 modelScript/creatures/dainu_lion/gen_muscle.py --list
  python3 modelScript/creatures/dainu_lion/gen_muscle.py --group hindleg
"""
