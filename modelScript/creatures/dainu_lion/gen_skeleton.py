...
用法:
  python3 modelScript/creatures/dainu_lion/gen_skeleton.py                  # 全骨架
  python3 modelScript/creatures/dainu_lion/gen_skeleton.py --part skull     # 单件预览
  python3 modelScript/creatures/dainu_lion/gen_skeleton.py --list           # 列出部件
"""
...
OUT_DIR = Path(__file__).resolve().parents[2] / "models" / "dainu_lion"
...
def main() -> int:
    ...
    ap.add_argument("--out", type=Path, help="输出路径（默认 modelScript/models/DainuLionSkeleton.bbmodel）")
    args = ap.parse_args()
