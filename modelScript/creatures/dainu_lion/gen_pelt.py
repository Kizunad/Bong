...
用法:
  python3 modelScript/creatures/dainu_lion/gen_pelt.py              # 完整外观
  python3 modelScript/creatures/dainu_lion/gen_pelt.py --with-anatomy  # 叠在骨+肌上看包裹关系
  python3 modelScript/creatures/dainu_lion/gen_pelt.py --group mane
  python3 modelScript/creatures/dainu_lion/gen_pelt.py --list
"""
