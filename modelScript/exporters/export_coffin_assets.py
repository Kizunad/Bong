...
以 ``modelScript/models/{Mundane,Jade,Stone,Bronze}Coffin.bbmodel`` 为基准（用户已在 Blockbench
...
用法:
  python3 modelScript/exporters/export_coffin_assets.py            # 导出全部 4 档
  python3 modelScript/exporters/export_coffin_assets.py --verify   # 仅跑 CoffinCommon oracle 自检
  python3 modelScript/exporters/export_coffin_assets.py --tier jade
"""
