...
本脚本生成专用模型源文件，对齐仓库管线：
    ...
    modelScript/models/MundaneCoffin.bbmodel   ← 本脚本产物（Blockbench 源）
...
用法:
    python3 modelScript/generators/gen_mundane_coffin.py            # 写 bbmodel + 预览
    python3 modelScript/generators/gen_mundane_coffin.py --preview-only
"""
...
BBMODEL_OUT = Path(__file__).resolve().parents[1] / "models" / "MundaneCoffin.bbmodel"
PREVIEW_OUT = Path(__file__).resolve().parents[1] / "out" / "mundane_coffin_preview.png"
