...
bbmodel 是设计/手改源：
    ...
    modelScript/models/WoodenShield.bbmodel     ← 本脚本产物（Blockbench 源）
...
用法:
    python3 modelScript/generators/gen_wooden_shield.py
    python3 modelScript/generators/gen_wooden_shield.py --preview-only
"""
...
BBMODEL_OUT = Path(__file__).resolve().parents[1] / "models" / "WoodenShield.bbmodel"
PREVIEW_OUT = Path(__file__).resolve().parents[1] / "out" / "wooden_shield_preview.png"
