...
管线同前：modelScript/models/StoneCoffin.bbmodel → assets/bong/geo/stone_coffin.geo.json
...
BBMODEL_OUT = Path(__file__).resolve().parents[1] / "models" / "StoneCoffin.bbmodel"
PREVIEW_OUT = Path(__file__).resolve().parents[1] / "out" / "stone_coffin_preview.png"
