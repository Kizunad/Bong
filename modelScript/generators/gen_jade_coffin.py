...
管线同凡物档：
  modelScript/models/JadeCoffin.bbmodel → 导出 assets/bong/geo/jade_coffin.geo.json
...
BBMODEL_OUT = Path(__file__).resolve().parents[1] / "models" / "JadeCoffin.bbmodel"
PREVIEW_OUT = Path(__file__).resolve().parents[1] / "out" / "jade_coffin_preview.png"
