...
SRC = (Path(__file__).resolve().parents[1] / "models" / "devour_rat_v3_user2.bbmodel")
PALETTE = {
...
def main():
    ...
    out = Path(sys.argv[2]) if len(sys.argv) > 2 else (Path(__file__).resolve().parents[1] / "models" / "devour_rat_var.bbmodel")
