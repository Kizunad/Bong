...
pub fn payload_type_label(payload_type: ServerDataType) -> &'static str {
    match payload_type {
        ...
        ServerDataType::CoffinState => "coffin_state",
        ...
        ServerDataType::ShieldBroken => "shield_broken",
        ServerDataType::ShieldBlockHit => "shield_block_hit",
        ...
        ServerDataType::SpiritTreasureState => "spirit_treasure_state",
        ServerDataType::SpiritTreasureDialogue => "spirit_treasure_dialogue",
