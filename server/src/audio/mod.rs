...
mod tests {
    ...
    fn loads_default_audio_recipes() {
        ...
        assert_eq!(
            registry.len(),
            64,
            "audio registry should include MVP cues plus JueBi, botany visual cues, TSY experience, fauna-experience-v1 creature recipes, woliu-v2, dugu-v2, and baomai-v3 recipes"
        );
