...
#[doc(hidden)]
pub fn is_in_combat(state: &CombatState, current_tick: u64) -> bool {
    matches!(state.in_combat_until_tick, Some(t) if t > current_tick)
}

#[doc(hidden)]
pub fn damaged_this_tick(wounds: &Wounds, current_tick: u64) -> bool {
    wounds
        .entries
        .iter()
...
#[doc(hidden)]
pub fn find_key_in_inventory(inv: &PlayerInventory, kind: KeyKind) -> Option<u64> {
...
#[doc(hidden)]
pub fn place_loot_in_carried_inventory(
