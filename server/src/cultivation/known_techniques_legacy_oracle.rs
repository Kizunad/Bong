//! Immutable test-only oracle copied mechanically from the pre-datafication catalog.
//! It intentionally does not read the TOML asset or invoke the production loader.

use super::SkillCategory;
use crate::body_plan::RaceGate;

#[derive(Debug, Clone, Copy, PartialEq)]
pub(crate) struct LegacyTechniqueDefinition {
    pub id: &'static str,
    pub display_name: &'static str,
    pub grade: &'static str,
    pub description: &'static str,
    pub required_realm: &'static str,
    pub required_meridians: &'static [LegacyTechniqueRequiredMeridian],
...
#[derive(Debug, Clone, Copy, PartialEq)]
pub(crate) struct LegacyTechniqueRequiredMeridian {
    pub channel: &'static str,
    pub min_health: f32,
}

pub(crate) const LEGACY_TECHNIQUE_IDS: [&str; 49] = [
    "sword.cleave",
    "sword.thrust",
    "sword.parry",
    "sword.infuse",
...
pub(crate) const LEGACY_TECHNIQUE_DEFINITIONS: [LegacyTechniqueDefinition; 49] = [
    LegacyTechniqueDefinition {
        id: "sword.cleave",
        display_name: "劈",
        grade: "common",
    ...
    LegacyTechniqueDefinition {
        ...
        required_realm: "Induce",
        required_meridians: &[
            LegacyTechniqueRequiredMeridian {
    ...
    LegacyTechniqueDefinition {
        ...
        required_meridians: &[LegacyTechniqueRequiredMeridian {
            channel: "Stomach",
            min_health: 0.5,
        }],
        required_race: RaceGate::Humanoid,
