...
use bong_server::combat::components::CombatState;
use bong_server::combat::events::DeathEvent;
use bong_server::cultivation::components::{Cultivation, Realm};
use bong_server::cultivation::tick::{CultivationClock, CultivationSessionPracticeAccumulator};
...
use bong_server::world::territory::*;
use bong_server::world::territory_narration::{DominanceChangedEvent, DominanceEventKind};
use bong_server::world::territory_rumor::RealmBand;
use bong_server::world::tiandao_hunt::realm_rank;
use bong_server::world::zone::{Zone, ZoneRegistry};
use valence::prelude::{bevy_ecs, App, Update};
...
fn realm_rank_scales_influence() {
    ...
    let void_realm = compute_influence_delta(realm_rank(Realm::Void), false, false, 1.0, 0.0, 0);
...
fn make_qi_depleted_app(initial_qi: f64) -> App {
    use bong_server::world::territory_narration::ZoneQiWatermark;
...
fn scenario_1_accumulation_clamps_at_influence_max() {
    ...
    for _ in 0..60 {
        accum = (accum + compute_influence_delta(3, true, false, 1.0, 0.0, 0)).min(INFLUENCE_MAX);
    }
    assert!(
...
fn scenario_10_dominant_attention_accelerated_by_1_5x() {
    ...
    use bong_server::world::territory_perks::DOMINANCE_ATTENTION_MULT;
    ...
    let input_dominant = TiandaoAttentionInput {
        realm: bong_server::cultivation::components::Realm::Solidify,
        zone_spirit_qi: 0.8,
...
fn scenario_12_qi_depletion_accelerated_with_dominant_and_watch() {
    ...
    assert!(
        matches!(
            ...
            Some(bong_server::world::territory_narration::DominanceEventKind::QiDepleted)
        ),
...
fn scenario_14_npc_behavior_does_not_change_qi_ledger() {
    use bong_server::qi_physics::ledger::WorldQiAccount;
    use bong_server::world::territory_perks::{recompute_territory_perks, ZoneDominanceRegenStore};
    use valence::prelude::DVec3;
