//! Protobuf generated types 的协议 pin 测试。
...
mod tests {
    ...
    fn proto_vs_json_benchmark() {
        ...
        let proto_cultivation = ServerDataEnvelope {
            payload: Some(server_data_envelope::Payload::CultivationDetail(
                CultivationDetail {
                    realm: Realm::Solidify as i32,
                    meridians: bong_server::cultivation::components::MeridianId::ALL
                        .iter()
                        .enumerate()
                        .map(|(idx, m)| {
                            let i = (idx + 1) as u32;
    ...
    fn anqi_hud_proto_roundtrip_echo() {
        use bong_server::schema::proto_convert::server_data_to_proto_payload;
        use bong_server::schema::proto_gen::bong::ServerDataEnvelope;
        use bong_server::schema::server_data::{AnqiHudKindV1, AnqiHudV1, ServerDataPayloadV1};
        use prost::Message;
    ...
    fn dugu_v2_skill_cast_proto_roundtrip_eclipse() {
        use bong_server::schema::proto_convert::server_data_to_proto_payload;
        use bong_server::schema::proto_gen::bong::ServerDataEnvelope;
        use bong_server::schema::server_data::{DuguV2HudSkillCastV1, ServerDataPayloadV1};
        use prost::Message;
    ...
    fn dugu_v2_self_cure_proto_roundtrip_self_revealed_true() {
        use bong_server::schema::proto_convert::server_data_to_proto_payload;
        use bong_server::schema::proto_gen::bong::ServerDataEnvelope;
        use bong_server::schema::server_data::{DuguV2HudSelfCureV1, ServerDataPayloadV1};
        use prost::Message;
    ...
    fn dugu_v2_shroud_active_proto_roundtrip() {
        use bong_server::schema::proto_convert::server_data_to_proto_payload;
        use bong_server::schema::proto_gen::bong::ServerDataEnvelope;
        use bong_server::schema::server_data::{DuguV2HudShroudActiveV1, ServerDataPayloadV1};
        use prost::Message;
    ...
    fn permanent_qi_max_decay_applied_proto_roundtrip() {
        use bong_server::schema::proto_convert::server_data_to_proto_payload;
        use bong_server::schema::proto_gen::bong::ServerDataEnvelope;
        use bong_server::schema::server_data::{DuguV2HudQiDecayV1, ServerDataPayloadV1};
        use prost::Message;
    ...
    fn sword_bond_hud_proto_roundtrip_active() {
        use bong_server::schema::proto_convert::server_data_to_proto_payload;
        use bong_server::schema::proto_gen::bong::ServerDataEnvelope;
        use bong_server::schema::server_data::{ServerDataPayloadV1, SwordBondHudStateV1};
        use prost::Message;
    ...
    #[test]
    fn merged_protocol_pin_cases() {
        let cases: &[(&str, fn())] = &[
        ("realm_enum_has_all_6_stages_plus_unspecified", realm_enum_has_all_6_stages_plus_unspecified),
        ("skill_id_enum_has_6_skills_plus_unspecified", skill_id_enum_has_6_skills_plus_unspecified),
        ("color_kind_enum_has_10_colors_plus_unspecified", color_kind_enum_has_10_colors_plus_unspecified),
        ("vec3_roundtrip", vec3_roundtrip),
        ("item_slot_roundtrip_with_optional_fields", item_slot_roundtrip_with_optional_fields),
        ("welcome_message_roundtrip", welcome_message_roundtrip),
        ("server_data_envelope_welcome_roundtrip", server_data_envelope_welcome_roundtrip),
        ("server_data_envelope_cultivation_detail_roundtrip", server_data_envelope_cultivation_detail_roundtrip),
        ("server_data_envelope_cultivation_detail_supports_non_humanoid_channel_count", server_data_envelope_cultivation_detail_supports_non_humanoid_channel_count),
        ("client_request_envelope_set_meridian_target_roundtrip", client_request_envelope_set_meridian_target_roundtrip),
        ("client_request_envelope_set_meridian_target_accepts_non_humanoid_channel", client_request_envelope_set_meridian_target_accepts_non_humanoid_channel),
        ("client_request_envelope_breakthrough_roundtrip", client_request_envelope_breakthrough_roundtrip),
        ("empty_envelope_roundtrip", empty_envelope_roundtrip),
        ("narration_batch_empty_and_nonempty", narration_batch_empty_and_nonempty),
        ("zone_info_optional_fields", zone_info_optional_fields),
        ("player_state_optional_fields", player_state_optional_fields),
        ("narration_entry_with_optional_target_and_kind", narration_entry_with_optional_target_and_kind),
        ("narration_entry_without_optional_fields", narration_entry_without_optional_fields),
        ("narration_batch_all_styles_roundtrip", narration_batch_all_styles_roundtrip),
        ("narration_entry_all_kind_variants", narration_entry_all_kind_variants),
        ("player_state_full_fields_roundtrip", player_state_full_fields_roundtrip),
        ("player_state_without_optional_nested_messages", player_state_without_optional_nested_messages),
        ("player_state_envelope_roundtrip", player_state_envelope_roundtrip),
        ("cultivation_detail_full_fields_roundtrip", cultivation_detail_full_fields_roundtrip),
        ("cultivation_detail_empty_arrays_roundtrip", cultivation_detail_empty_arrays_roundtrip),
        ("cultivation_detail_envelope_roundtrip", cultivation_detail_envelope_roundtrip),
        ("skill_xp_gain_source_action_roundtrip", skill_xp_gain_source_action_roundtrip),
        ("skill_xp_gain_source_scroll_roundtrip", skill_xp_gain_source_scroll_roundtrip),
        ("skill_xp_gain_source_realm_breakthrough_roundtrip", skill_xp_gain_source_realm_breakthrough_roundtrip),
        ("skill_xp_gain_source_mentor_roundtrip", skill_xp_gain_source_mentor_roundtrip),
        ("skill_xp_gain_all_skill_ids", skill_xp_gain_all_skill_ids),
        ("skill_xp_gain_envelope_roundtrip", skill_xp_gain_envelope_roundtrip),
        ("inventory_item_view_full_roundtrip", inventory_item_view_full_roundtrip),
        ("inventory_item_view_minimal_roundtrip", inventory_item_view_minimal_roundtrip),
        ("inventory_snapshot_empty_roundtrip", inventory_snapshot_empty_roundtrip),
        ("inventory_snapshot_with_items_roundtrip", inventory_snapshot_with_items_roundtrip),
        ("inventory_snapshot_envelope_roundtrip", inventory_snapshot_envelope_roundtrip),
        ("inventory_item_view_all_rarity_values", inventory_item_view_all_rarity_values),
        ("combat_hud_state_full_roundtrip", combat_hud_state_full_roundtrip),
        ("combat_hud_state_zeros_roundtrip", combat_hud_state_zeros_roundtrip),
        ("combat_hud_state_max_values", combat_hud_state_max_values),
        ("combat_hud_state_without_derived", combat_hud_state_without_derived),
        ("combat_hud_state_envelope_roundtrip", combat_hud_state_envelope_roundtrip),
        ("knockback_sync_with_collision_damage", knockback_sync_with_collision_damage),
        ("knockback_sync_without_collision_damage", knockback_sync_without_collision_damage),
        ("knockback_sync_boundary_values", knockback_sync_boundary_values),
        ("knockback_sync_zero_values", knockback_sync_zero_values),
        ("knockback_sync_envelope_roundtrip", knockback_sync_envelope_roundtrip),
        ("alchemy_furnace_roundtrip", alchemy_furnace_roundtrip),
        ("alchemy_furnace_no_pos_roundtrip", alchemy_furnace_no_pos_roundtrip),
        ("alchemy_session_roundtrip", alchemy_session_roundtrip),
        ("alchemy_session_empty_stages_roundtrip", alchemy_session_empty_stages_roundtrip),
        ("alchemy_outcome_forecast_roundtrip", alchemy_outcome_forecast_roundtrip),
        ("alchemy_outcome_resolved_full_roundtrip", alchemy_outcome_resolved_full_roundtrip),
        ("alchemy_outcome_resolved_explode_with_damage_roundtrip", alchemy_outcome_resolved_explode_with_damage_roundtrip),
        ("alchemy_recipe_book_roundtrip", alchemy_recipe_book_roundtrip),
        ("alchemy_recipe_book_empty_roundtrip", alchemy_recipe_book_empty_roundtrip),
        ("alchemy_contamination_roundtrip", alchemy_contamination_roundtrip),
        ("alchemy_open_furnace_roundtrip", alchemy_open_furnace_roundtrip),
        ("alchemy_feed_slot_roundtrip", alchemy_feed_slot_roundtrip),
        ("alchemy_take_back_roundtrip", alchemy_take_back_roundtrip),
        ("alchemy_ignite_roundtrip", alchemy_ignite_roundtrip),
        ("alchemy_intervention_adjust_temp_roundtrip", alchemy_intervention_adjust_temp_roundtrip),
        ("alchemy_intervention_inject_qi_proto_roundtrip", alchemy_intervention_inject_qi_proto_roundtrip),
        ("alchemy_intervention_auto_profile_proto_roundtrip", alchemy_intervention_auto_profile_proto_roundtrip),
        ("alchemy_turn_page_roundtrip", alchemy_turn_page_roundtrip),
        ("alchemy_learn_recipe_roundtrip", alchemy_learn_recipe_roundtrip),
        ("alchemy_learn_recipe_fragment_roundtrip", alchemy_learn_recipe_fragment_roundtrip),
        ("alchemy_take_pill_roundtrip", alchemy_take_pill_roundtrip),
        ("forge_station_roundtrip", forge_station_roundtrip),
        ("forge_session_data_billet_roundtrip", forge_session_data_billet_roundtrip),
        ("forge_session_data_tempering_roundtrip", forge_session_data_tempering_roundtrip),
        ("forge_session_data_consecration_with_color_roundtrip", forge_session_data_consecration_with_color_roundtrip),
        ("forge_session_data_none_state_roundtrip", forge_session_data_none_state_roundtrip),
        ("forge_session_data_inscription_step_roundtrip", forge_session_data_inscription_step_roundtrip),
        ("forge_outcome_roundtrip", forge_outcome_roundtrip),
        ("forge_outcome_flawed_with_color_roundtrip", forge_outcome_flawed_with_color_roundtrip),
        ("forge_blueprint_book_roundtrip", forge_blueprint_book_roundtrip),
        ("forge_start_session_roundtrip", forge_start_session_roundtrip),
        ("forge_tempering_hit_roundtrip", forge_tempering_hit_roundtrip),
        ("forge_inscription_scroll_roundtrip", forge_inscription_scroll_roundtrip),
        ("forge_consecration_inject_roundtrip", forge_consecration_inject_roundtrip),
        ("forge_step_advance_roundtrip", forge_step_advance_roundtrip),
        ("forge_blueprint_turn_page_roundtrip", forge_blueprint_turn_page_roundtrip),
        ("forge_learn_blueprint_roundtrip", forge_learn_blueprint_roundtrip),
        ("craft_recipe_list_roundtrip", craft_recipe_list_roundtrip),
        ("craft_recipe_list_empty_roundtrip", craft_recipe_list_empty_roundtrip),
        ("craft_recipe_entry_with_requirements_roundtrip", craft_recipe_entry_with_requirements_roundtrip),
        ("craft_session_state_active_roundtrip", craft_session_state_active_roundtrip),
        ("craft_session_state_inactive_roundtrip", craft_session_state_inactive_roundtrip),
        ("craft_outcome_completed_roundtrip", craft_outcome_completed_roundtrip),
        ("craft_outcome_failed_roundtrip", craft_outcome_failed_roundtrip),
        ("recipe_unlocked_scroll_source_roundtrip", recipe_unlocked_scroll_source_roundtrip),
        ("recipe_unlocked_mentor_source_roundtrip", recipe_unlocked_mentor_source_roundtrip),
        ("recipe_unlocked_insight_source_roundtrip", recipe_unlocked_insight_source_roundtrip),
        ("craft_start_roundtrip", craft_start_roundtrip),
        ("craft_cancel_roundtrip", craft_cancel_roundtrip),
        ("botany_harvest_progress_full_roundtrip", botany_harvest_progress_full_roundtrip),
        ("botany_harvest_progress_no_pos_roundtrip", botany_harvest_progress_no_pos_roundtrip),
        ("botany_plant_v2_render_profiles_roundtrip", botany_plant_v2_render_profiles_roundtrip),
        ("botany_plant_v2_render_profile_with_secondary_roundtrip", botany_plant_v2_render_profile_with_secondary_roundtrip),
        ("botany_skill_roundtrip", botany_skill_roundtrip),
        ("botany_harvest_request_manual_roundtrip", botany_harvest_request_manual_roundtrip),
        ("botany_harvest_request_auto_roundtrip", botany_harvest_request_auto_roundtrip),
        ("mining_progress_roundtrip", mining_progress_roundtrip),
        ("mining_progress_completed_roundtrip", mining_progress_completed_roundtrip),
        ("lumber_progress_roundtrip", lumber_progress_roundtrip),
        ("gathering_session_roundtrip", gathering_session_roundtrip),
        ("gathering_session_no_tool_roundtrip", gathering_session_no_tool_roundtrip),
        ("lingtian_session_data_active_roundtrip", lingtian_session_data_active_roundtrip),
        ("lingtian_session_data_replenish_roundtrip", lingtian_session_data_replenish_roundtrip),
        ("lingtian_session_data_inactive_roundtrip", lingtian_session_data_inactive_roundtrip),
        ("lingtian_session_dye_contamination_warning_roundtrip", lingtian_session_dye_contamination_warning_roundtrip),
        ("lingtian_start_till_roundtrip", lingtian_start_till_roundtrip),
        ("lingtian_start_renew_roundtrip", lingtian_start_renew_roundtrip),
        ("lingtian_start_planting_roundtrip", lingtian_start_planting_roundtrip),
        ("lingtian_start_harvest_roundtrip", lingtian_start_harvest_roundtrip),
        ("lingtian_start_replenish_roundtrip", lingtian_start_replenish_roundtrip),
        ("lingtian_start_drain_qi_roundtrip", lingtian_start_drain_qi_roundtrip),
        ("mineral_probe_roundtrip", mineral_probe_roundtrip),
        ("wounds_snapshot_roundtrip_nonempty", wounds_snapshot_roundtrip_nonempty),
        ("wounds_snapshot_roundtrip_empty", wounds_snapshot_roundtrip_empty),
        ("wounds_snapshot_envelope_roundtrip", wounds_snapshot_envelope_roundtrip),
        ("defense_window_roundtrip", defense_window_roundtrip),
        ("defense_window_envelope_roundtrip", defense_window_envelope_roundtrip),
        ("cast_sync_envelope_roundtrip", cast_sync_envelope_roundtrip),
        ("quick_slot_config_roundtrip_mixed_slots", quick_slot_config_roundtrip_mixed_slots),
        ("skill_bar_config_roundtrip_item_and_skill", skill_bar_config_roundtrip_item_and_skill),
        ("techniques_snapshot_roundtrip", techniques_snapshot_roundtrip),
        ("techniques_snapshot_empty", techniques_snapshot_empty),
        ("unlocks_sync_roundtrip", unlocks_sync_roundtrip),
        ("derived_attrs_sync_roundtrip", derived_attrs_sync_roundtrip),
        ("weapon_equipped_roundtrip_with_weapon", weapon_equipped_roundtrip_with_weapon),
        ("weapon_equipped_roundtrip_without_weapon", weapon_equipped_roundtrip_without_weapon),
        ("weapon_broken_roundtrip", weapon_broken_roundtrip),
        ("shield_broken_roundtrip_wooden", shield_broken_roundtrip_wooden),
        ("shield_broken_roundtrip_bone", shield_broken_roundtrip_bone),
        ("shield_block_hit_roundtrip_wooden", shield_block_hit_roundtrip_wooden),
        ("shield_block_hit_roundtrip_bone", shield_block_hit_roundtrip_bone),
        ("treasure_equipped_roundtrip_with_treasure", treasure_equipped_roundtrip_with_treasure),
        ("treasure_equipped_roundtrip_without_treasure", treasure_equipped_roundtrip_without_treasure),
        ("vortex_field_state_roundtrip", vortex_field_state_roundtrip),
        ("dugu_poison_state_roundtrip_active", dugu_poison_state_roundtrip_active),
        ("dugu_poison_state_roundtrip_cleared", dugu_poison_state_roundtrip_cleared),
        ("poison_dose_event_roundtrip_all_tags", poison_dose_event_roundtrip_all_tags),
        ("poison_overdose_event_roundtrip_all_severities", poison_overdose_event_roundtrip_all_severities),
        ("poison_trait_state_roundtrip", poison_trait_state_roundtrip),
        ("carrier_state_roundtrip_with_instance_id", carrier_state_roundtrip_with_instance_id),
        ("carrier_state_roundtrip_without_instance_id", carrier_state_roundtrip_without_instance_id),
        ("false_skin_state_roundtrip_with_layers", false_skin_state_roundtrip_with_layers),
        ("false_skin_state_roundtrip_empty", false_skin_state_roundtrip_empty),
        ("combat_event_floater_roundtrip", combat_event_floater_roundtrip),
        ("combat_event_floater_empty", combat_event_floater_empty),
        ("technique_proficiency_update_roundtrip", technique_proficiency_update_roundtrip),
        ("pill_buff_status_roundtrip", pill_buff_status_roundtrip),
        ("skill_config_snapshot_proto_roundtrip", skill_config_snapshot_proto_roundtrip),
        ("skill_config_snapshot_proto_empty", skill_config_snapshot_proto_empty),
        ("jiemai_c2s_roundtrip", jiemai_c2s_roundtrip),
        ("charge_carrier_roundtrip_with_slot", charge_carrier_roundtrip_with_slot),
        ("charge_carrier_roundtrip_without_slot", charge_carrier_roundtrip_without_slot),
        ("throw_carrier_roundtrip", throw_carrier_roundtrip),
        ("anqi_container_switch_roundtrip_cycle", anqi_container_switch_roundtrip_cycle),
        ("anqi_container_switch_roundtrip_direct", anqi_container_switch_roundtrip_direct),
        ("use_quick_slot_roundtrip", use_quick_slot_roundtrip),
        ("quick_slot_bind_roundtrip_bind", quick_slot_bind_roundtrip_bind),
        ("quick_slot_bind_roundtrip_clear", quick_slot_bind_roundtrip_clear),
        ("skill_bar_cast_roundtrip_with_target", skill_bar_cast_roundtrip_with_target),
        ("skill_bar_cast_roundtrip_without_target", skill_bar_cast_roundtrip_without_target),
        ("skill_bar_bind_roundtrip_item", skill_bar_bind_roundtrip_item),
        ("skill_bar_bind_roundtrip_skill", skill_bar_bind_roundtrip_skill),
        ("skill_bar_bind_roundtrip_clear", skill_bar_bind_roundtrip_clear),
        ("skill_config_intent_roundtrip", skill_config_intent_roundtrip),
        ("combat_reincarnate_roundtrip", combat_reincarnate_roundtrip),
        ("combat_terminate_roundtrip", combat_terminate_roundtrip),
        ("combat_create_new_character_roundtrip", combat_create_new_character_roundtrip),
        ("b2_s2c_all_envelope_variants_roundtrip", b2_s2c_all_envelope_variants_roundtrip),
        ("b2_c2s_all_envelope_variants_roundtrip", b2_c2s_all_envelope_variants_roundtrip),
        ("exposure_kind_enum_has_all_4_variants_plus_unspecified", exposure_kind_enum_has_all_4_variants_plus_unspecified),
        ("guardian_kind_enum_has_all_3_variants_plus_unspecified", guardian_kind_enum_has_all_3_variants_plus_unspecified),
        ("social_anonymity_roundtrip_with_remotes", social_anonymity_roundtrip_with_remotes),
        ("social_anonymity_roundtrip_empty_remotes", social_anonymity_roundtrip_empty_remotes),
        ("social_exposure_roundtrip_all_exposure_kinds", social_exposure_roundtrip_all_exposure_kinds),
        ("social_exposure_roundtrip_no_zone", social_exposure_roundtrip_no_zone),
        ("social_pact_roundtrip_broken_and_intact", social_pact_roundtrip_broken_and_intact),
        ("social_feud_roundtrip_with_and_without_place", social_feud_roundtrip_with_and_without_place),
        ("social_renown_delta_roundtrip_with_tags", social_renown_delta_roundtrip_with_tags),
        ("social_renown_delta_roundtrip_no_tags", social_renown_delta_roundtrip_no_tags),
        ("identity_panel_state_roundtrip_with_entries", identity_panel_state_roundtrip_with_entries),
        ("identity_panel_state_roundtrip_empty", identity_panel_state_roundtrip_empty),
        ("niche_intrusion_roundtrip_with_items", niche_intrusion_roundtrip_with_items),
        ("niche_intrusion_roundtrip_no_items", niche_intrusion_roundtrip_no_items),
        ("niche_guardian_fatigue_roundtrip_all_guardian_kinds", niche_guardian_fatigue_roundtrip_all_guardian_kinds),
        ("niche_guardian_broken_roundtrip", niche_guardian_broken_roundtrip),
        ("sparring_invite_roundtrip", sparring_invite_roundtrip),
        ("trade_offer_roundtrip_with_requested_items", trade_offer_roundtrip_with_requested_items),
        ("trade_offer_roundtrip_no_requested_items", trade_offer_roundtrip_no_requested_items),
        ("spirit_niche_place_c2s_roundtrip", spirit_niche_place_c2s_roundtrip),
        ("spirit_niche_gaze_c2s_roundtrip", spirit_niche_gaze_c2s_roundtrip),
        ("spirit_niche_mark_coordinate_c2s_roundtrip", spirit_niche_mark_coordinate_c2s_roundtrip),
        ("spirit_niche_activate_guardian_c2s_roundtrip_all_kinds", spirit_niche_activate_guardian_c2s_roundtrip_all_kinds),
        ("spirit_niche_activate_guardian_c2s_empty_materials", spirit_niche_activate_guardian_c2s_empty_materials),
        ("sparring_invite_response_c2s_roundtrip_accept_and_decline", sparring_invite_response_c2s_roundtrip_accept_and_decline),
        ("trade_offer_request_c2s_roundtrip", trade_offer_request_c2s_roundtrip),
        ("trade_offer_response_c2s_roundtrip_accepted_and_declined", trade_offer_response_c2s_roundtrip_accepted_and_declined),
        ("npc_inspect_request_c2s_roundtrip", npc_inspect_request_c2s_roundtrip),
        ("npc_dialogue_choice_c2s_roundtrip", npc_dialogue_choice_c2s_roundtrip),
        ("npc_trade_request_c2s_roundtrip_with_and_without_offers", npc_trade_request_c2s_roundtrip_with_and_without_offers),
        ("b3_s2c_all_envelope_variants_roundtrip", b3_s2c_all_envelope_variants_roundtrip),
        ("b3_c2s_all_envelope_variants_roundtrip", b3_c2s_all_envelope_variants_roundtrip),
        ("tribulation_state_envelope_roundtrip", tribulation_state_envelope_roundtrip),
        ("tribulation_state_cleared_roundtrip", tribulation_state_cleared_roundtrip),
        ("tribulation_broadcast_active_roundtrip", tribulation_broadcast_active_roundtrip),
        ("tribulation_broadcast_clear_roundtrip", tribulation_broadcast_clear_roundtrip),
        ("ascension_quota_envelope_roundtrip", ascension_quota_envelope_roundtrip),
        ("ascension_quota_zero_values_roundtrip", ascension_quota_zero_values_roundtrip),
        ("heart_demon_offer_envelope_roundtrip", heart_demon_offer_envelope_roundtrip),
        ("heart_demon_offer_empty_choices_roundtrip", heart_demon_offer_empty_choices_roundtrip),
        ("insight_offer_envelope_roundtrip", insight_offer_envelope_roundtrip),
        ("insight_offer_empty_choices_roundtrip", insight_offer_empty_choices_roundtrip),
        ("burst_meridian_event_envelope_roundtrip", burst_meridian_event_envelope_roundtrip),
        ("burst_meridian_event_no_target_roundtrip", burst_meridian_event_no_target_roundtrip),
        ("breakthrough_cinematic_envelope_roundtrip", breakthrough_cinematic_envelope_roundtrip),
        ("breakthrough_cinematic_interrupted_roundtrip", breakthrough_cinematic_interrupted_roundtrip),
        ("death_screen_full_roundtrip", death_screen_full_roundtrip),
        ("death_screen_minimal_roundtrip", death_screen_minimal_roundtrip),
        ("death_screen_tribulation_stage_roundtrip", death_screen_tribulation_stage_roundtrip),
        ("terminate_screen_envelope_roundtrip", terminate_screen_envelope_roundtrip),
        ("terminate_screen_hidden_roundtrip", terminate_screen_hidden_roundtrip),
        ("qi_color_observed_envelope_roundtrip", qi_color_observed_envelope_roundtrip),
        ("qi_color_observed_no_secondary_roundtrip", qi_color_observed_no_secondary_roundtrip),
        ("realm_vision_params_envelope_roundtrip", realm_vision_params_envelope_roundtrip),
        ("realm_vision_params_sphere_fog_roundtrip", realm_vision_params_sphere_fog_roundtrip),
        ("spiritual_sense_targets_envelope_roundtrip", spiritual_sense_targets_envelope_roundtrip),
        ("spiritual_sense_targets_empty_roundtrip", spiritual_sense_targets_empty_roundtrip),
        ("b4_s2c_all_envelope_variants_roundtrip", b4_s2c_all_envelope_variants_roundtrip),
        ("start_du_xu_envelope_roundtrip", start_du_xu_envelope_roundtrip),
        ("abort_tribulation_envelope_roundtrip", abort_tribulation_envelope_roundtrip),
        ("heart_demon_decision_chosen_envelope_roundtrip", heart_demon_decision_chosen_envelope_roundtrip),
        ("heart_demon_decision_timeout_envelope_roundtrip", heart_demon_decision_timeout_envelope_roundtrip),
        ("duo_she_request_envelope_roundtrip", duo_she_request_envelope_roundtrip),
        ("qi_color_inspect_envelope_roundtrip", qi_color_inspect_envelope_roundtrip),
        ("use_life_core_envelope_roundtrip", use_life_core_envelope_roundtrip),
        ("b4_c2s_all_envelope_variants_roundtrip", b4_c2s_all_envelope_variants_roundtrip),
        ("event_alert_envelope_roundtrip", event_alert_envelope_roundtrip),
        ("coffin_state_envelope_roundtrip", coffin_state_envelope_roundtrip),
        ("ui_open_envelope_roundtrip", ui_open_envelope_roundtrip),
        ("inventory_event_moved_roundtrip", inventory_event_moved_roundtrip),
        ("inventory_event_stack_changed_roundtrip", inventory_event_stack_changed_roundtrip),
        ("inventory_event_durability_changed_roundtrip", inventory_event_durability_changed_roundtrip),
        ("dropped_loot_sync_envelope_roundtrip", dropped_loot_sync_envelope_roundtrip),
        ("rift_portal_state_roundtrip", rift_portal_state_roundtrip),
        ("rift_portal_removed_roundtrip", rift_portal_removed_roundtrip),
        ("extract_started_roundtrip", extract_started_roundtrip),
        ("extract_progress_roundtrip", extract_progress_roundtrip),
        ("extract_completed_roundtrip", extract_completed_roundtrip),
        ("extract_aborted_roundtrip", extract_aborted_roundtrip),
        ("extract_failed_roundtrip", extract_failed_roundtrip),
        ("tsy_collapse_started_roundtrip", tsy_collapse_started_roundtrip),
        ("container_state_roundtrip", container_state_roundtrip),
        ("search_started_roundtrip", search_started_roundtrip),
        ("search_progress_roundtrip", search_progress_roundtrip),
        ("search_completed_roundtrip", search_completed_roundtrip),
        ("search_aborted_roundtrip", search_aborted_roundtrip),
        ("skill_lv_up_roundtrip", skill_lv_up_roundtrip),
        ("skill_cap_changed_roundtrip", skill_cap_changed_roundtrip),
        ("skill_scroll_used_roundtrip", skill_scroll_used_roundtrip),
        ("skill_snapshot_roundtrip", skill_snapshot_roundtrip),
        ("full_power_charging_state_roundtrip", full_power_charging_state_roundtrip),
        ("full_power_release_roundtrip", full_power_release_roundtrip),
        ("full_power_exhausted_state_roundtrip", full_power_exhausted_state_roundtrip),
        ("healer_npc_ai_state_roundtrip", healer_npc_ai_state_roundtrip),
        ("yidao_hud_state_roundtrip", yidao_hud_state_roundtrip),
        ("movement_state_roundtrip", movement_state_roundtrip),
        ("spirit_treasure_state_roundtrip", spirit_treasure_state_roundtrip),
        ("spirit_treasure_dialogue_roundtrip", spirit_treasure_dialogue_roundtrip),
        ("vfx_event_play_anim_roundtrip", vfx_event_play_anim_roundtrip),
        ("vfx_event_spawn_particle_roundtrip", vfx_event_spawn_particle_roundtrip),
        ("audio_play_event_roundtrip", audio_play_event_roundtrip),
        ("audio_stop_event_roundtrip", audio_stop_event_roundtrip),
        ("ambient_zone_event_roundtrip", ambient_zone_event_roundtrip),
        ("zone_environment_state_roundtrip", zone_environment_state_roundtrip),
        ("mutation_state_roundtrip", mutation_state_roundtrip),
        ("mutation_event_roundtrip", mutation_event_roundtrip),
        ("dandao_style_roundtrip", dandao_style_roundtrip),
        ("tsy_enter_event_roundtrip", tsy_enter_event_roundtrip),
        ("tsy_exit_event_roundtrip", tsy_exit_event_roundtrip),
        ("tsy_npc_spawned_roundtrip", tsy_npc_spawned_roundtrip),
        ("tsy_sentinel_phase_changed_roundtrip", tsy_sentinel_phase_changed_roundtrip),
        ("void_action_suppress_tsy_roundtrip", void_action_suppress_tsy_roundtrip),
        ("movement_action_request_roundtrip", movement_action_request_roundtrip),
        ("forge_request_c2s_roundtrip", forge_request_c2s_roundtrip),
        ("insight_decision_roundtrip", insight_decision_roundtrip),
        ("alchemy_furnace_place_roundtrip", alchemy_furnace_place_roundtrip),
        ("coffin_open_roundtrip", coffin_open_roundtrip),
        ("coffin_leave_roundtrip", coffin_leave_roundtrip),
        ("zhenfa_place_roundtrip", zhenfa_place_roundtrip),
        ("zhenfa_kind_enum_includes_trap_runtime_variants", zhenfa_kind_enum_includes_trap_runtime_variants),
        ("zhenfa_trigger_roundtrip", zhenfa_trigger_roundtrip),
        ("zhenfa_disarm_roundtrip", zhenfa_disarm_roundtrip),
        ("learn_skill_scroll_roundtrip", learn_skill_scroll_roundtrip),
        ("inventory_move_intent_roundtrip", inventory_move_intent_roundtrip),
        ("equip_false_skin_roundtrip", equip_false_skin_roundtrip),
        ("forge_false_skin_roundtrip", forge_false_skin_roundtrip),
        ("apply_pill_roundtrip", apply_pill_roundtrip),
        ("self_antidote_roundtrip", self_antidote_roundtrip),
        ("start_extract_request_roundtrip", start_extract_request_roundtrip),
        ("cancel_extract_request_roundtrip", cancel_extract_request_roundtrip),
        ("start_search_roundtrip", start_search_roundtrip),
        ("cancel_search_roundtrip", cancel_search_roundtrip),
        ("forge_station_place_roundtrip", forge_station_place_roundtrip),
        ("repair_weapon_intent_roundtrip", repair_weapon_intent_roundtrip),
        ("pickup_dropped_item_roundtrip", pickup_dropped_item_roundtrip),
        ("b5_s2c_all_envelope_variants_roundtrip", b5_s2c_all_envelope_variants_roundtrip),
        ("b5_c2s_all_envelope_variants_roundtrip", b5_c2s_all_envelope_variants_roundtrip),
        ("proto_vs_json_benchmark", proto_vs_json_benchmark),
        ("anqi_hud_proto_roundtrip_echo", anqi_hud_proto_roundtrip_echo),
        ("anqi_hud_proto_roundtrip_aim_preserves_nonzero_progress", anqi_hud_proto_roundtrip_aim_preserves_nonzero_progress),
        ("anqi_hud_proto_roundtrip_abrasion", anqi_hud_proto_roundtrip_abrasion),
        ("anqi_hud_proto_roundtrip_charge", anqi_hud_proto_roundtrip_charge),
        ("dugu_v2_skill_cast_proto_roundtrip_eclipse", dugu_v2_skill_cast_proto_roundtrip_eclipse),
        ("dugu_v2_skill_cast_proto_roundtrip_shroud_no_target", dugu_v2_skill_cast_proto_roundtrip_shroud_no_target),
        ("dugu_v2_self_cure_proto_roundtrip_self_revealed_true", dugu_v2_self_cure_proto_roundtrip_self_revealed_true),
        ("dugu_v2_self_cure_proto_roundtrip_self_revealed_false", dugu_v2_self_cure_proto_roundtrip_self_revealed_false),
        ("dugu_v2_shroud_active_proto_roundtrip", dugu_v2_shroud_active_proto_roundtrip),
        ("permanent_qi_max_decay_applied_proto_roundtrip", permanent_qi_max_decay_applied_proto_roundtrip),
        ("sword_bond_hud_proto_roundtrip_active", sword_bond_hud_proto_roundtrip_active),
        ("sword_bond_hud_proto_roundtrip_heaven_gate_ready", sword_bond_hud_proto_roundtrip_heaven_gate_ready),
        ("sword_bond_hud_proto_roundtrip_inactive", sword_bond_hud_proto_roundtrip_inactive),
        ];
