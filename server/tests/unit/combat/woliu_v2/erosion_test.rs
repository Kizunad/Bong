use bong_server::combat::woliu_v2::erosion::*;
use bong_server::combat::woliu_v2::events::WoliuSkillId;
...
fn echo_misfire_probability_by_stage() {
    ...
    assert!((VoidErosionStage::EchoBody.echo_misfire_probability() - 0.10).abs() < f64::EPSILON);
    assert!((VoidErosionStage::VoidEroded.echo_misfire_probability() - 0.25).abs() < f64::EPSILON);
}
