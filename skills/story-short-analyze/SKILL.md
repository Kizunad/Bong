...
description: 短篇网文拆文分析，聚焦结构拆解、情绪曲线、反转机制与开头结尾钩子，帮助复盘爆款短篇的可复用方法。触发方式：/story-short-analyze、/短篇拆文、「帮我拆这个短篇」「分析这篇故事」。注意：本 skill 适用于通用网文创作，非末法残土世界观叙事（末法残土请用 /write-tale）。
argument-hint: [标题] [平台]
