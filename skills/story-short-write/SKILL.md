...
description: 短篇网文写作辅助，覆盖情绪目标设定、反转设计、分段起承转合与成稿精修，聚焦高完读与传播性。触发方式：/story-short-write、/写短篇、「帮我写一篇短篇」「写个盐言故事」。注意：本 skill 适用于通用网文创作，非末法残土世界观叙事（末法残土请用 /write-tale）。
argument-hint: <题材方向或情绪目标>
