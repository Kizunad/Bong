---
name: story-deslop
description: 网文去AI味润色，识别并清除高频AI腔、套路句式与过度工整表达，在不改剧情意图前提下让文本更自然有人味。触发方式：/story-deslop、/去AI味、「去AI味」「去味」「deslop」「这篇太AI了」。注意：本 skill 适用于通用网文创作，非末法残土世界观叙事（末法残土请用 /write-tale）。
argument-hint: [可选：文本或文件路径]
