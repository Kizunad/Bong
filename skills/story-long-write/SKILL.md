...
description: 长篇网文写作辅助，覆盖选题、世界观、人设、卷纲与正文推进，适合从零开书与连载工程化写作。触发方式：/story-long-write、/写长篇、/story、/网文、「帮我开书」「写大纲」。注意：本 skill 适用于通用网文创作，非末法残土世界观叙事（末法残土请用 /write-tale）。
argument-hint: <题材> [目标平台]
