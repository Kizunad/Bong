...
description: 短篇网文扫榜与风口追踪，分析知乎盐言、番茄短篇、七猫等平台热门数据，提炼情绪趋势、题材热点与可切入方向。触发方式：/story-short-scan、/短篇扫榜、「短篇什么火」「知乎故事排行」。注意：本 skill 适用于通用网文创作，非末法残土世界观叙事（末法残土请用 /write-tale）。
argument-hint: [平台：知乎盐言/番茄短篇/七猫]
