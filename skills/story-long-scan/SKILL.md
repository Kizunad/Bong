...
description: 长篇网文扫榜与市场研判，面向起点、番茄、晋江等平台提炼题材趋势、榜单模式与可落地方向。触发方式：/story-long-scan、/长篇扫榜、「长篇什么火」「起点排行」。注意：本 skill 适用于通用网文创作，非末法残土世界观叙事（末法残土请用 /write-tale）。
argument-hint: [平台：起点/番茄/晋江] [题材方向]
