...
POSE = {
    ...
    2: dict(
        ...
        rightArm=dict(pitch=-55, yaw=-32, roll=+14, bend=25, axis=180),
        leftArm=dict(pitch=-55, yaw=+32, roll=-14, bend=25, axis=180),
    ...
    3: dict(
        ...
        rightArm=dict(pitch=-58, yaw=-38, roll=+16, bend=20, axis=180),
        leftArm=dict(pitch=-58, yaw=+38, roll=-16, bend=20, axis=180),
    ...
    5: dict(
        ...
        rightArm=dict(pitch=-62, yaw=+18, roll=-10, bend=118, axis=180),
        leftArm=dict(pitch=-58, yaw=-18, roll=+10, bend=122, axis=180),
    ...
    7: dict(
        ...
        rightArm=dict(pitch=-64, yaw=+20, roll=-11, bend=124, axis=180),
        leftArm=dict(pitch=-60, yaw=-20, roll=+11, bend=128, axis=180),
    ...
    8: dict(
        ...
        head=dict(pitch=+6),
        torso=dict(pitch=+8, yaw=0),
        rightArm=dict(pitch=-63, yaw=+19, roll=-10, bend=122, axis=180),
        leftArm=dict(pitch=-59, yaw=-19, roll=+10, bend=126, axis=180),
    ...
    9: dict(
        ...
        head=dict(pitch=+2),
        torso=dict(pitch=+5, yaw=0),
        rightArm=dict(pitch=-52, yaw=+5, roll=-2, bend=90, axis=180),
        leftArm=dict(pitch=-50, yaw=-5, roll=+2, bend=92, axis=180),
...
def main() -> int:
    emit_json(
        ...
        name="zhenmai_harden",
        description=(
            "P1 重制抱臂硬化：anticipation 0→3 双臂外张开劲（yaw ±38 / bend 20），"
            "strike 3→5 猛收交叉抱胸（bend 118/122 / yaw 内扣 ±18）+沉桩"
