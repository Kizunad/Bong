...
POSE = {
    ...
    4: dict(
        ...
        rightArm=dict(pitch=-18, yaw=-12, roll=+4, bend=30, axis=180),
        leftArm=dict(pitch=-18, yaw=+12, roll=-4, bend=30, axis=180),
    ...
    6: dict(
        ...
        rightArm=dict(pitch=-16, yaw=-16, roll=+2, bend=26, axis=180),
        leftArm=dict(pitch=-16, yaw=+16, roll=-2, bend=26, axis=180),
