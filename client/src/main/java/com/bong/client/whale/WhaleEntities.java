...
public final class WhaleEntities {
     ...
     *
     * <p>Fabric 注册顺序敏感：当前生产契约不包含 GeckoLib dev examples；
     * BongClient 再注册 botany_plant_v2 (raw_id=124) → whale (125) → fauna (126..=133)。
     * 后续 plan-entity-model-v1 的 raw id 由 BongEntityRegistry 的 EntityType 注册顺序决定
     * (134..=144)，BongEntityRenderBootstrap 只绑定 renderer。任何新 Bong EntityType 插队都会让
