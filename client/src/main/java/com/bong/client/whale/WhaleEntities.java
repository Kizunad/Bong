...
public final class WhaleEntities {
     ...
     * BongClient 再注册 botany_plant_v2 (raw_id=124) → whale (125) → fauna (126..=145) →
     * BongEntityRegistry (146..=148 物资棺三档 + 149..=159 plan-entity-model-v1)。
     * BongEntityRenderBootstrap 只绑定 renderer。任何新 Bong EntityType 插队都会让
