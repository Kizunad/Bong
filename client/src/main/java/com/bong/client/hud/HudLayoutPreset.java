...
public enum HudLayoutPreset {
    ...
    static Widget widgetFor(HudRenderLayer layer) {
        ...
        return switch (layer) {
            ...
            case THREAT_INDICATOR, EDGE_FEEDBACK, NEAR_DEATH, TRIBULATION, FACTION_WAR -> Widget.THREAT;
            ...
            case PROCESSING_HUD, SEARCH_PROGRESS, TSY_EXTRACT, EXTRACT_DECISION, HOME_SEQUENCE, REALM_COLLAPSE, GATHERING -> Widget.PROCESSING;
