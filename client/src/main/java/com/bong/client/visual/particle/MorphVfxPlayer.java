 ...
 *       lifetime {@link #SPIRAL_LIFETIME_TICKS}=30t，色 {@code #E8DFC8}，
 ...
 *       lifetime {@link #MIST_LIFETIME_TICKS}=20t，复用 {@link BongParticles#cloudDustSprites}
...
public final class MorphVfxPlayer implements VfxPlayer {
    ...
    public void play(MinecraftClient client, VfxEventPayload.SpawnParticle payload) {
        ...
        spawnSpiral(client, world, origin, r, g, b);
        spawnMist(client, world, origin);
    ...
    private static void spawnSpiral(
        ...
        for (int i = 0; i < SPIRAL_RIBBON_COUNT; i++) {
            ...
            ribbon.setMaxAgePublic(SPIRAL_LIFETIME_TICKS);
    ...
    private static void spawnMist(MinecraftClient client, ClientWorld world, double[] origin) {
        for (int i = 0; i < MIST_SPRITE_COUNT; i++) {
            ...
            mist.setMaxAgePublic(MIST_LIFETIME_TICKS);
