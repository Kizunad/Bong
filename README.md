...
_六境修炼、天劫、炼丹/炼器、矿物、灵田、保质期 · 28 份 · 组均 93%_
...
| `wip` | **种族 BodyPlan 通用化+固元易形功法** <br/><sub>`plan-race-system-v1.md`</sub> | `██████████░░`  80% | #1160 #1180 #1184 #1198 #1201 #1202 #1203 #1204 #1206 #1250 | 2026-07-26 |
...
_背包、NPC AI、感知、社交、技艺、死亡周期 · 36 份 · 组均 80%_
...
| `design` | **草药捆保鲜挂载 + 草镰采集接通** <br/><sub>`plan-gathering-tool-bind-v1.md`</sub> | `░░░░░░░░░░░░`   0% | — | 2026-06-14 |
