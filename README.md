...
_自动生成于 2026-04-30 · 共 74 份 plan_

```
总进度  █████████████████████░░░░░░░░░  68.5%
```

**分布**：`merged` 4 · `wip` 7 · `design` 8 · `skeleton` 14 · `done` 41

### 战斗 / HUD / 视觉
_战斗 ECS、流派、HUD、粒子、动画、Iris · 5 份 · 组均 65%_

| 状态 | Plan | 进度 | PR | 最近更新 |
|---|---|---|---|---|
| `wip` | **战斗系统客户端 UI 全部组件实现** <br/><sub>`plan-combat-ui_impl.md`</sub> | `███████████░`  88% | #20 | 2026-04-25 |
| `wip` | **客户端全局 HUD（双层快捷栏+三状态条+事件流）** <br/><sub>`plan-HUD-v1.md`</sub> | `██████████░░`  82% | #18 #43 | 2026-04-25 |
| `wip` | **武器法宝完整链路（ItemInstance→Weapon Component→3D 渲染）** <br/><sub>`plan-weapon-v1.md`</sub> | `█████████░░░`  78% | #41 | 2026-04-25 |
| `wip` | **粒子与世界内 VFX 系统（三基类 + S2C 协议 + 首批资产）** <br/><sub>`plan-particle-system-v1.md`</sub> | `█████████░░░`  72% | #17 | 2026-04-28 |
| `design` | **Iris 光影集成与修仙 shader uniform 注入** <br/><sub>`plan-iris-integration-v1.md`</sub> | `█░░░░░░░░░░░`   5% | — | 2026-04-25 |

### 修炼 / 经济
_六境修炼、天劫、炼丹/炼器、矿物、灵田、保质期 · 7 份 · 组均 42%_
...
### 玩法 / NPC / 世界
_背包、NPC AI、感知、社交、技艺、死亡周期 · 2 份 · 组均 50%_
...
### 基础设施 / 工作流
_IPC schema、持久化、工作流、内容、音效 · 2 份 · 组均 71%_
...
### 已完成归档
_M0/M1 阶段产物 + 已 docs/finished_plans 的子 plan · 41 份 · 组均 100%_
