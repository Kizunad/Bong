...
**分布**：`merged` 43 · `wip` 4 · `design` 3 · `skeleton` 9 · `done` 46
...
### 修炼 / 经济
_六境修炼、天劫、炼丹/炼器、矿物、灵田、保质期 · 18 份 · 组均 90%_
...
| `design` | **化虚专属 action（镇压/引爆/阻挡/传承）** <br/><sub>`plan-void-actions-v1.md`</sub> | `██░░░░░░░░░░`  15% | — | 2026-05-08 |
