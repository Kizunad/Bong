...
用法:
  python3 scripts/models/horse/render_anim.py                    # 全部动画（常马）侧视连拍
  python3 scripts/models/horse/render_anim.py --only walk trot --gif
  python3 scripts/models/horse/render_anim.py --profile large --view 34
"""
