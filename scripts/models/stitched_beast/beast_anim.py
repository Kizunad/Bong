...
用法:
  python3 scripts/models/stitched_beast/beast_anim.py --seed 7
  python3 scripts/models/stitched_beast/beast_anim.py --seed 7 --list
  python3 scripts/models/stitched_beast/beast_anim.py --all
"""
