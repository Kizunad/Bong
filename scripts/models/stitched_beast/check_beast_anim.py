...
用法:
  python3 scripts/models/stitched_beast/check_beast_anim.py
  python3 scripts/models/stitched_beast/check_beast_anim.py --seed 7
  python3 scripts/models/stitched_beast/check_beast_anim.py --all
"""
