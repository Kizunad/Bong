...
用法:
  python3 scripts/models/mimic_spider/preview.py                  # 框架折叠断言+渲染
  python3 scripts/models/mimic_spider/preview.py --model shell    # 甲壳折叠断言+渲染
  python3 scripts/models/mimic_spider/preview.py --stance [--model shell]
"""
