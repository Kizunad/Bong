...
用法:
  python3 scripts/models/mimic_spider/gen_frame.py               # 全框架
  python3 scripts/models/mimic_spider/gen_frame.py --part legs   # 单件预览
  python3 scripts/models/mimic_spider/gen_frame.py --list
"""
...
OUT_DIR = REPO / "local_models" / "mimic_spider"
...
def part_prosoma(rig: Rig) -> None:
    ...
    # 眼丘 + 8 眼窝：不对称簇——中央主眼一对偏大，侧眼两排，右侧一枚刻意抬高 0.5。
    # 对称的眼阵是装饰，不对称的眼阵在"看你"。
