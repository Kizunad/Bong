...
用法:
    python3 scripts/models/gen_bamboo_jian.py               # 双锏
    python3 scripts/models/gen_bamboo_jian.py --single      # 单根（导手持 item 模型用）
    python3 scripts/models/gen_bamboo_jian.py --preview-only
    python3 scripts/models/render_bbmodel.py local_models/BambooJian.bbmodel --three-view
"""
...
BBMODEL_OUT = REPO / "local_models" / "BambooJian.bbmodel"
PREVIEW_OUT = REPO / "scripts" / "models" / "bamboo_jian_preview.png"
