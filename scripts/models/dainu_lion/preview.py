...
产出（均落在 scripts/models/dainu_lion/）：
...
用法:
  python3 scripts/models/dainu_lion/preview.py           # 全部
  python3 scripts/models/dainu_lion/preview.py --atlas   # 只出图集
  python3 scripts/models/dainu_lion/preview.py --skip-gen  # 不重生成，只渲染现有 bbmodel
"""
