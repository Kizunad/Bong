...
用法:
  python3 scripts/models/kekeda_goose/render_anim.py                 # 全部，侧视连拍
  python3 scripts/models/kekeda_goose/render_anim.py --only poop lay_egg --gif
  python3 scripts/models/kekeda_goose/render_anim.py --only walk --view 34
"""
