...
用法:
  python3 scripts/models/kekeda_goose/gen_muscle.py                 # 骨 + 肌
  python3 scripts/models/kekeda_goose/gen_muscle.py --only-muscle   # 只肌肉
  python3 scripts/models/kekeda_goose/gen_muscle.py --group breast  # 单肌群叠在骨架上
  python3 scripts/models/kekeda_goose/gen_muscle.py --explode 5     # 延展视图
  python3 scripts/models/kekeda_goose/gen_muscle.py --list
"""
