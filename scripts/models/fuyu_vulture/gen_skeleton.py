...
用法:
  python3 scripts/models/fuyu_vulture/gen_skeleton.py                    # 三档全出
  python3 scripts/models/fuyu_vulture/gen_skeleton.py --size mid         # 单档
  python3 scripts/models/fuyu_vulture/gen_skeleton.py --size mid --pose spread
  python3 scripts/models/fuyu_vulture/gen_skeleton.py --size mid --part skull
  python3 scripts/models/fuyu_vulture/gen_skeleton.py --check            # 只跑自检
  python3 scripts/models/fuyu_vulture/gen_skeleton.py --list
"""
...
def main() -> int:
    ...
    ap.add_argument("--out-dir", type=Path, help="输出目录（默认 local_models/fuyu_vulture）")
    args = ap.parse_args()
