...
用法:
  python3 scripts/models/fuyu_vulture/render_anim.py                    # 全部，侧视连拍
  python3 scripts/models/fuyu_vulture/render_anim.py --only walk --gif
  python3 scripts/models/fuyu_vulture/render_anim.py --view 34 --size large
"""
