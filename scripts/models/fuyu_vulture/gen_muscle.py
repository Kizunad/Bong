...
用法:
  python3 scripts/models/fuyu_vulture/gen_muscle.py                     # 三档，骨+肌
  python3 scripts/models/fuyu_vulture/gen_muscle.py --size mid
  python3 scripts/models/fuyu_vulture/gen_muscle.py --size mid --only-muscle
  python3 scripts/models/fuyu_vulture/gen_muscle.py --size mid --group flight
  python3 scripts/models/fuyu_vulture/gen_muscle.py --size mid --explode 5
  python3 scripts/models/fuyu_vulture/gen_muscle.py --check
  python3 scripts/models/fuyu_vulture/gen_muscle.py --list
"""
