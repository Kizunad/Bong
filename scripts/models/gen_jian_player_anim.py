...
用法:
    python3 scripts/models/gen_jian_player_anim.py
    python3 scripts/models/gen_jian_player_anim.py --anims jian_dual_smash lower_sprint
"""
...
OUT_BB = REPO / "local_models" / "JianPlayerAnim.bbmodel"
