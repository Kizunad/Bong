...
用法:
  python3 scripts/models/to_fmt410.py IN.bbmodel [OUT.bbmodel]
  python3 scripts/models/to_fmt410.py --check IN.bbmodel      # 只报告，不写
"""
...
# 4.10 的贴图条目形状（对照 local_models/DainuLionMuscle.bbmodel）
